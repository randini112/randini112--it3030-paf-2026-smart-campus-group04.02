...
let advancedMockData = [
  ...
  { id: '3', name: 'Server Rack 04', type: 'EQUIPMENT', capacity: null, location: 'IT Dept Server Room', building: 'IT Block', floor: '1', status: 'OUT_OF_SERVICE', availStart: '00:00', availEnd: '23:59', description: 'High-density rack server for departmental compute workloads.' },
  ...
  { id: '7', name: 'Projector X-200 (Mobile)', type: 'EQUIPMENT', capacity: null, location: 'Admin Office', building: 'Admin Block', floor: '1', status: 'ACTIVE', availStart: '08:00', availEnd: '20:00', description: 'Portable high-lumen projector for presentations and events.' },
  ...
  { id: '14', name: '3D Printer Farm', type: 'EQUIPMENT', capacity: null, location: 'Innovation Hub', building: 'Innovation Hub', floor: '1', status: 'ACTIVE', availStart: '09:00', availEnd: '19:00', description: 'Cluster of FDM and SLA 3D printers for rapid prototyping.' },
  ...
  { id: '17', name: 'PA System (Portable)', type: 'EQUIPMENT', capacity: null, location: 'Student Union', building: 'Student Union', floor: '1', status: 'ACTIVE', availStart: '08:00', availEnd: '22:00', description: 'Portable PA system for events, including speakers, mixer, and microphones.' },
  ...
  { id: '19', name: 'Data Center C', type: 'EQUIPMENT', capacity: null, location: 'IT Dept Server Room', building: 'IT Block', floor: 'Basement', status: 'ACTIVE', availStart: '00:00', availEnd: '23:59', description: 'Campus data center hosting institutional databases and cloud infrastructure.' },
  ...
  { id: '23', name: 'Oscilloscope Set (10 Units)', type: 'EQUIPMENT', capacity: null, location: 'Engineering Block', building: 'Engineering Block', floor: '1', status: 'ACTIVE', availStart: '08:00', availEnd: '18:00', description: 'Set of digital oscilloscopes for electronics and signal processing labs.' },
  ...
  { id: '25', name: 'Multimedia Lab', type: 'LAB', capacity: 45, location: 'IT Wing, Floor 2', building: 'IT Block', floor: '2', status: 'ACTIVE', availStart: '08:00', availEnd: '21:00', description: 'Creative media lab with video editing suites, recording booths, and green screen.' }
];
