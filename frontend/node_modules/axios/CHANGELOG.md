...
- **fetch:** fix stream handling in Safari by fallback to using a stream reader instead of an async iterator; ([#6584](https://github.com/axios/axios/issues/6584)) ([d198099](https://github.com/axios/axios/commit/d1980994fee1765cd02fa0787adf5d6e34dd9dcf))
